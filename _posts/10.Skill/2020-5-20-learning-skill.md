...
2016年底，我戴着QA的帽子加入ThoughtWorks，仿佛一脚跨进了知识爆炸的时代，琳琅满目的学习素材、开放的网络、分享型的组织文化、一张张打满鸡血的脸庞……我浑身充满干劲，但同时饱尝着能力进阶的压力和焦虑。
于是，我不断探索适合自身成长的方法。

----------

我个人逻辑性比较好、但跳跃性思维不够。因此，做任何事情时，喜欢分析清楚前因后果，然后按部就班地进行。对于自身成长，如果我脑子里没有框架，学习再多的东西都会觉得一团乱麻。因此，我很重视构建自己的成长体系。

什么是“自我成长体系”？就是通过设立目标，对知识进行筛选，然后逐步制定提升计划，采用正确的方法汲取知识，最后在实践中去打磨。
